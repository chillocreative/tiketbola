...
const submit = () => {
    ...
    })).post(route('admin.submissions.store'));
};
</script>
    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-3">
                ...
                <h2 class="text-xl font-bold text-white">Tambah Pendaftaran</h2>
            </div>
        </template>
                        ...
                        <form @submit.prevent="submit" class="space-y-5">
                            <div>
                                ...
                                <input v-model="form.name" type="text" required
                                    class="block w-full rounded-xl border-0 bg-white/10 px-4 py-3 text-sm uppercase text-white placeholder-gray-500 ring-1 ring-white/10 focus:ring-2 focus:ring-yellow-400" placeholder="Nama penuh" />
                            ...
                            <div>
                                ...
                                <input v-model="form.ic_number" type="text" inputmode="numeric" required maxlength="12" @input="onlyDigits('ic_number', 12)"
                                    class="block w-full rounded-xl border-0 bg-white/10 px-4 py-3 text-sm text-white placeholder-gray-500 ring-1 ring-white/10 focus:ring-2 focus:ring-yellow-400" placeholder="901234105678" />
                            ...
                            <div>
                                ...
                                <input v-model="form.phone" type="tel" inputmode="numeric" required maxlength="11" @input="onlyDigits('phone', 11)"
                                    class="block w-full rounded-xl border-0 bg-white/10 px-4 py-3 text-sm text-white placeholder-gray-500 ring-1 ring-white/10 focus:ring-2 focus:ring-yellow-400" placeholder="01234567890" />
                            ...
                            <div>
                                ...
                                <textarea v-model="form.address" rows="3" required
                                    class="block w-full rounded-xl border-0 bg-white/10 px-4 py-3 text-sm uppercase text-white placeholder-gray-500 ring-1 ring-white/10 focus:ring-2 focus:ring-yellow-400" placeholder="Alamat penuh"></textarea>
